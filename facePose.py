...
def main():        
    ...
    # Initialize a set to store unique movement conditbions for all frames
    ...
    if len(all_frames_conditions) >= 3:
        text = "Head estimation passed  Liveliness Verified"
        print(text)
        return text
        # match_images(runtime_image, file_image_path)
    else:
        text = "Head estimation failed  Liveliness not Verified"
        print(text)
        return text
